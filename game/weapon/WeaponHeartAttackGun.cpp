...
class rvWeaponHeartAttackGun : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvWeaponHeartAttackGun);

	rvWeaponHeartAttackGun(void);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvWeaponHeartAttackGun);
};

CLASS_DECLARATION(rvWeapon, rvWeaponHeartAttackGun)
END_CLASS

/*
================
rvWeaponHeartAttackGun::rvWeaponHeartAttackGun
================
*/
rvWeaponHeartAttackGun::rvWeaponHeartAttackGun(void) {
}

/*
================
rvWeaponHeartAttackGun::UpdateFlashlight
================
*/
bool rvWeaponHeartAttackGun::UpdateFlashlight(void) {
	if (!wsfl.flashlight) {
		return false;
	}
...
/*
================
rvWeaponHeartAttackGun::Flashlight
================
*/
void rvWeaponHeartAttackGun::Flashlight(bool on) {
	owner->Flashlight(on);
...
/*
================
rvWeaponHeartAttackGun::UpdateAttack
================
*/
bool rvWeaponHeartAttackGun::UpdateAttack(void) {
	// Clear fire forced
	if (fireForced) {
		if (!wsfl.attack) {
			fireForced = false;
...
/*
================
rvWeaponHeartAttackGun::Spawn
================
*/
void rvWeaponHeartAttackGun::Spawn(void) {
...
/*
================
rvWeaponHeartAttackGun::Save
================
*/
void rvWeaponHeartAttackGun::Save(idSaveGame* savefile) const {
...
/*
================
rvWeaponHeartAttackGun::Restore
================
*/
void rvWeaponHeartAttackGun::Restore(idRestoreGame* savefile) {
...
/*
================
rvWeaponHeartAttackGun::PreSave
================
*/
void rvWeaponHeartAttackGun::PreSave(void) {
...
/*
================
rvWeaponHeartAttackGun::PostSave
================
*/
void rvWeaponHeartAttackGun::PostSave(void) {
}
...
CLASS_STATES_DECLARATION(rvWeaponHeartAttackGun)
STATE("Raise", rvWeaponHeartAttackGun::State_Raise)
STATE("Lower", rvWeaponHeartAttackGun::State_Lower)
STATE("Idle", rvWeaponHeartAttackGun::State_Idle)
STATE("Charge", rvWeaponHeartAttackGun::State_Charge)
STATE("Charged", rvWeaponHeartAttackGun::State_Charged)
STATE("Fire", rvWeaponHeartAttackGun::State_Fire)
STATE("Flashlight", rvWeaponHeartAttackGun::State_Flashlight)
END_CLASS_STATES

/*
================
rvWeaponHeartAttackGun::State_Raise
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Raise(const stateParms_t& parms) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};
...
/*
================
rvWeaponHeartAttackGun::State_Lower
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Lower(const stateParms_t& parms) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
rvWeaponHeartAttackGun::State_Idle
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Idle(const stateParms_t& parms) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};
...
/*
================
rvWeaponHeartAttackGun::State_Charge
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Charge(const stateParms_t& parms) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};
...
/*
================
rvWeaponHeartAttackGun::State_Charged
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Charged(const stateParms_t& parms) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};
...
/*
================
rvWeaponHeartAttackGun::State_Fire
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Fire(const stateParms_t& parms) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};
...
/*
================
rvWeaponHeartAttackGun::State_Flashlight
================
*/
stateResult_t rvWeaponHeartAttackGun::State_Flashlight(const stateParms_t& parms) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};
