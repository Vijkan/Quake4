...
class rvWeaponTaser : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvWeaponTaser);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvWeaponTaser);
};

CLASS_DECLARATION(rvWeapon, rvWeaponTaser)
EVENT(EV_Lightninggun_RestoreHum, rvWeaponTaser::Event_RestoreHum)
END_CLASS

/*
================
rvWeaponTaser::rvWeaponTaser
================
*/
rvWeaponTaser::rvWeaponTaser(void) {
}
...
================
*/
void rvWeaponTaser::Save(idSaveGame* savefile) const {
	int i;
...
/*
================
rvWeaponTaser::Restore
================
*/
void rvWeaponTaser::Restore(idRestoreGame* savefile) {
	int   i;
	int   num;
	float f;
...
/*
================
rvWeaponTaser::Attack
================
*/
void rvWeaponTaser::Attack(idEntity* ent, const idVec3& dir, float power) {
	// Double check
...
/*
================
rvWeaponTaser::UpdateChainLightning
================
*/
void rvWeaponTaser::UpdateChainLightning(void) {
	int					i;
...
/*
================
rvWeaponTaser::UpdateEffects
================
*/
void rvWeaponTaser::UpdateEffects(const idVec3& origin) {
	int					i;
	rvLightningPath* parent;
	idVec3				dir;
...
/*
================
rvWeaponTaser::UpdateTrailEffect
================
*/
void rvWeaponTaser::UpdateTrailEffect(rvClientEffectPtr& effect, const idVec3& start, const idVec3& end, bool view) {
	idVec3 dir;
	dir = end - start;
	dir.Normalize();
...
/*
================
rvWeaponTaser::StopChainLightning
================
*/
void rvWeaponTaser::StopChainLightning(void) {
	int	i;
...
/*
================
rvWeaponTaser::ClientStale
================
*/
void rvWeaponTaser::ClientStale(void) {
...
/*
================
rvWeaponTaser::PreSave
================
*/
void rvWeaponTaser::PreSave(void) {
...
/*
================
rvWeaponTaser::PostSave
================
*/
void rvWeaponTaser::PostSave(void) {
	//restore the humming
...
/*
================
rvWeaponTaser::UpdateTubes
================
*/
void rvWeaponTaser::UpdateTubes(void) {
	idAnimator* animator;
...
CLASS_STATES_DECLARATION(rvWeaponTaser)
STATE("Raise", rvWeaponTaser::State_Raise)
STATE("Lower", rvWeaponTaser::State_Lower)
STATE("Idle", rvWeaponTaser::State_Idle)
STATE("Fire", rvWeaponTaser::State_Fire)
END_CLASS_STATES

/*
================
rvWeaponTaser::State_Raise
================
*/
stateResult_t rvWeaponTaser::State_Raise(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponTaser::State_Lower
================
*/
stateResult_t rvWeaponTaser::State_Lower(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
rvWeaponTaser::State_Idle
================
*/
stateResult_t rvWeaponTaser::State_Idle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponTaser::State_Fire
================
*/
stateResult_t rvWeaponTaser::State_Fire(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_ATTACKLOOP,
		STAGE_DONE,
...
/*
================
rvWeaponTaser::Event_RestoreHum
================
*/
void rvWeaponTaser::Event_RestoreHum(void) {
	StopSound(SND_CHANNEL_BODY3, false);
	StartSound("snd_idle_hum", SND_CHANNEL_BODY3, 0, false, NULL);
}
