...
class rvWeaponMinigun : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvWeaponMinigun);

	rvWeaponMinigun(void);
	~rvWeaponMinigun(void);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvWeaponMinigun);
};

CLASS_DECLARATION(rvWeapon, rvWeaponMinigun)
END_CLASS

/*
================
rvWeaponMinigun::rvWeaponMinigun
================
*/
rvWeaponMinigun::rvWeaponMinigun(void) {
}
...
/*
================
rvWeaponMinigun::Spawn
================
*/
void rvWeaponMinigun::Spawn(void) {
...
/*
================
rvWeaponMinigun::Save
================
*/
void rvWeaponMinigun::Save(idSaveGame* savefile) const {
...
/*
================
rvWeaponMinigun::Restore
================
*/
void rvWeaponMinigun::Restore(idRestoreGame* savefile) {
...
/*
================
rvWeaponMinigun::PreSave
================
*/
void rvWeaponMinigun::PreSave(void) {
...
/*
================
rvWeaponMinigun::PostSave
================
*/
void rvWeaponMinigun::PostSave(void) {
...
/*
================
rvWeaponMinigun::CancelGuide
================
*/
void rvWeaponMinigun::CancelGuide(void) {
	if (zoomGui && guideEnt) {
...
/*
================
rvWeaponMinigun::UpdateGuideStatus
================
*/
void rvWeaponMinigun::UpdateGuideStatus(float range) {
...
/*
================
rvWeaponMinigun::Think
================
*/
void rvWeaponMinigun::Think(void) {
	idEntity* ent;
	trace_t	  tr;
...
/*
================
rvWeaponMinigun::OnLaunchProjectile
================
*/
void rvWeaponMinigun::OnLaunchProjectile(idProjectile* proj) {
...
/*
================
rvWeaponMinigun::DrumSpin

Set the drum spin speed
================
*/
bool rvWeaponMinigun::DrumSpin(int speed, int blendFrames) {
...
CLASS_STATES_DECLARATION(rvWeaponMinigun)
STATE("Raise", rvWeaponMinigun::State_Raise)
STATE("Lower", rvWeaponMinigun::State_Lower)
STATE("Idle", rvWeaponMinigun::State_Idle)
STATE("Fire", rvWeaponMinigun::State_Fire)
STATE("Reload", rvWeaponMinigun::State_Reload)
STATE("DrumSpinDown", rvWeaponMinigun::State_DrumSpinDown)
STATE("DrumSpinUp", rvWeaponMinigun::State_DrumSpinUp)

STATE("ClaspOpen", rvWeaponMinigun::Frame_ClaspOpen)
STATE("ClaspClose", rvWeaponMinigun::Frame_ClaspClose)
END_CLASS_STATES

/*
================
rvWeaponMinigun::State_Raise

Raise the weapon
================
*/
stateResult_t rvWeaponMinigun::State_Raise(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponMinigun::State_Lower

Lower the weapon
================
*/
stateResult_t rvWeaponMinigun::State_Lower(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
rvWeaponMinigun::State_Idle

Manage the idle state of the weapon
================
*/
stateResult_t rvWeaponMinigun::State_Idle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponMinigun::State_Fire

Fire the weapon
================
*/
stateResult_t rvWeaponMinigun::State_Fire(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_FIRE,
		STAGE_FIREWAIT,
...
/*
================
rvWeaponMinigun::State_Reload
================
*/
stateResult_t rvWeaponMinigun::State_Reload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_RELOAD,
		STAGE_RELOADWAIT,
...
/*
================
rvWeaponMinigun::State_DrumSpinUp

Spin the drum from a slow speed to a fast speed
================
*/
stateResult_t rvWeaponMinigun::State_DrumSpinUp(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponMinigun::State_DrumSpinDown

Spin the drum down from a faster speed
================
*/
stateResult_t rvWeaponMinigun::State_DrumSpinDown(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponMinigun::Frame_ClaspOpen

Open the clasp that holds in the clips
================
*/
stateResult_t rvWeaponMinigun::Frame_ClaspOpen(const stateParms_t& parms) {
...
================
*/
stateResult_t rvWeaponMinigun::Frame_ClaspClose(const stateParms_t& parms) {
	if (mods & NAILGUN_MOD_ROF_AMMO) {
